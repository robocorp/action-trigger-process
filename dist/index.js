...
const helpers_1 = __nccwpck_require__(1857);
const headers = {
    Authorization: `RC-WSKEY ${(0, core_1.getInput)('api-key')}`,
...
const triggerProcess = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const url = `${(0, core_1.getInput)('api-endpoint')}/workspaces/${(0, core_1.getInput)('workspace-id')}/processes/${(0, core_1.getInput)('process-id')}/runs`;
    const response = yield (0, node_fetch_1.default)(url, { method: 'POST', body: JSON.stringify({ variables: body }), headers });
...
const awaitProcess = (processUrl) => __awaiter(void 0, void 0, void 0, function* () {
    const timeout = +(0, core_1.getInput)('timeout') * 1000;
    const endTime = new Date().getTime() + timeout;
    let attempt = 1;
    while (new Date().getTime() < endTime) {
        try {
            const response = yield (0, node_fetch_1.default)(processUrl, { headers });
            const json = (yield response.json());
            if (json.state === 'COMPL') {
                (0, core_1.setOutput)('run-id', json.id);
                (0, core_1.setOutput)('duration', json.duration);
                (0, core_1.setOutput)('robotrun-ids', json.robotRuns.map(({ id }) => id).join(','));
                (0, core_1.setOutput)('state', json.result);
            ...
            if (json.state === 'PENDING') {
                ...
                const shouldFail = (0, core_1.getInput)('fail-on-robot-fail');
